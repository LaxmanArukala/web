...
import { LawyerResponse, LawyerResponseById } from "../models/lawyersModel";
...
const LawyerDetailsPage = () => {
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery<LawyerResponseById, Error>({
    queryKey: ["AllLawyers", id],
    queryFn: () => getLawyerById(id as string), // ✅ Type assertion instead of parameter typing
  ...
  console.log("lawyerResponse", lawyerResponse);
              ...
              <div className="p-8">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    {lawyerResponse?.data?.data?.practiceareas?.length !== 0  && (
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900 mb-3">
                          Practice Areas
                        </h3>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div
                          ...
                          >
                            <Shield className="h-4 w-4 text-green-500 mr-2" />
                            {lawyerResponse?.data?.data?.bar_asso_name} ({lawyerResponse?.data?.data?.bar_councle_no})
                          </div>
                      </div>
                    </div>
                  </div>
                ...
                {activeTab === "experience" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {lawyerResponse?.data?.data?.achievements.map((achievement, index) => (
                          <div
                            key={index}
                            className="flex items-center text-gray-600"
                          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6">
              Schedule a consultation with {lawyer.name} to discuss your legal
              matter.
            </p>
